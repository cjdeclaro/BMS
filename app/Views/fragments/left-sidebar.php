                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="<?= base_url() ?>" class="sidebar-link" style="padding-left: 20px"><i class="fa fa-plus"></i><span class="hide-menu"> Add New </span></a></li>
                                <li class="sidebar-item"><a href="<?= base_url() ?>" class="sidebar-link" style="padding-left: 20px"><i class="fa fa-list"></i><span class="hide-menu"> View All </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> 
